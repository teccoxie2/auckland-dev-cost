  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-8">
      ...
      <header className="mt-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="text-sm text-[#7a5a2b]">地块核算</p>
      ...
      <section className="mt-8">
        <h2 className="text-lg font-semibold">开发选项</h2>
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-[#5c6754]">
        {option.template.dwellings} 套 · {option.template.bedrooms} 房 {option.template.bathrooms} 卫 · {option.template.storeys} 层 · {option.template.gfa_m2} m²
      </p>
      {blocked ? (
    ...
    <section className="mt-8 rounded-2xl border border-[#d9d0c0] bg-[#fffaf3] p-5 sm:p-6">
      ...
      {option.quantities ? (
        <p className="mt-4 text-xs leading-5 text-[#7b8474]">
          占地 {option.quantities.footprint_m2} m² · 90×45 木材 {option.quantities.timber_90_lm} m · E2 风险分 {option.quantities.e2.score}
